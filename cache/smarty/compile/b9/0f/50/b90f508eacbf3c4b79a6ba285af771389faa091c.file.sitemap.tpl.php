<?php /* Smarty version Smarty-3.1.14, created on 2014-01-06 14:21:44
         compiled from "C:\xampp\htdocs\e-commerce\themes\default-bootstrap\sitemap.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3035652caade802e120-41261954%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b90f508eacbf3c4b79a6ba285af771389faa091c' => 
    array (
      0 => 'C:\\xampp\\htdocs\\e-commerce\\themes\\default-bootstrap\\sitemap.tpl',
      1 => 1387468850,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3035652caade802e120-41261954',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52caade8750513_53600586',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52caade8750513_53600586')) {function content_52caade8750513_53600586($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\xampp\\htdocs\\e-commerce\\tools\\smarty\\plugins\\modifier.escape.php';
?>
	...
	<div class="col-xs-12 col-sm-6">
		<div class="sitemap_block box">
    		...
    		<ul>
    			<li>
                    <a 
                    href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('new-products'), 'html', 'UTF-8');?>
" 
...
">
    			...
    			<?php if (!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value){?>
        			<li>
                        <a 
                        href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('best-sales'), 'html', 'UTF-8');?>
" 
...
">
        			...
        			<li>
                        <a 
                        href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('prices-drop'), 'html', 'UTF-8');?>
" 
...
">
    			...
    			<?php if ($_smarty_tpl->tpl_vars['display_manufacturer_link']->value||$_smarty_tpl->tpl_vars['PS_DISPLAY_SUPPLIERS']->value){?>
                    <li>
                        <a 
                        href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('manufacturer'), 'html', 'UTF-8');?>
" 
...
">
    			...
    			<?php if ($_smarty_tpl->tpl_vars['display_supplier_link']->value||$_smarty_tpl->tpl_vars['PS_DISPLAY_SUPPLIERS']->value){?>
                    <li>
                        <a 
                        href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('supplier'), 'html', 'UTF-8');?>
" 
		...
		<div class="sitemap_block box">
    		...
    		<ul>
        		<?php if ($_smarty_tpl->tpl_vars['logged']->value){?>
        			<li>
                        <a 
                        href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('my-account',true), 'html', 'UTF-8');?>
" 
                        rel="nofollow" 
...
">
        			...
        			<li>
                        <a 
                        href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('identity',true), 'html', 'UTF-8');?>
" 
                        rel="nofollow" 
...
">
        			...
        			<li>
                        <a 
                        href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('addresses',true), 'html', 'UTF-8');?>
" 
                        rel="nofollow" 
...
">
        			...
        			<?php if ($_smarty_tpl->tpl_vars['voucherAllowed']->value){?>
                        <li>
                            <a 
                            href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('discount',true), 'html', 'UTF-8');?>
" 
                            rel="nofollow" 
...
">
        			...
        			<li>
                        <a 
                        href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('history',true), 'html', 'UTF-8');?>
" 
                        rel="nofollow"
...
" >
        		...
        		<?php }else{ ?>
        			<li>
                        <a 
                        href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('authentication',true), 'html', 'UTF-8');?>
" 
                        rel="nofollow"
...
" >
                            <?php echo smartyTranslate(array('s'=>'Log out'),$_smarty_tpl);?>
...
" title="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['categoriesTree']->value['name'], 'html', 'UTF-8');?>
"></a>
            </div>
            <ul class="tree">
...
?>
    ...
    <div class="col-xs-12 col-sm-6">
		<div class="sitemap_block box">
            ...
            <ul>
            	<li>
                    <a href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['categoriescmsTree']->value['link'], 'html', 'UTF-8');?>
" title="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['categoriescmsTree']->value['name'], 'html', 'UTF-8');?>
">
                        <?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['categoriescmsTree']->value['name'], 'html', 'UTF-8');?>
...
?>
                    <li>
                        <a href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['cms']->value['link'], 'html', 'UTF-8');?>
" title="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['cms']->value['meta_title'], 'html', 'UTF-8');?>
">
                            <?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['cms']->value['meta_title'], 'html', 'UTF-8');?>
