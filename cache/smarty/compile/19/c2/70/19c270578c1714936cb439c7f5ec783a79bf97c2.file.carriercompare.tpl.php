<?php /* Smarty version Smarty-3.1.14, created on 2014-01-06 14:21:10
         compiled from "C:\xampp\htdocs\e-commerce\themes\default-bootstrap\modules\carriercompare\template\carriercompare.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1584652caadc6820df2-57985180%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '19c270578c1714936cb439c7f5ec783a79bf97c2' => 
    array (
      0 => 'C:\\xampp\\htdocs\\e-commerce\\themes\\default-bootstrap\\modules\\carriercompare\\template\\carriercompare.tpl',
      1 => 1387468850,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1584652caadc6820df2-57985180',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52caadc6b47453_15159521',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52caadc6b47453_15159521')) {function content_52caadc6b47453_15159521($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\xampp\\htdocs\\e-commerce\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
loader.gif" alt="Loading data" /><br />
		...
		<p class="alert alert-warning text-center" id="noCarrier" style="display: none;"><?php echo smartyTranslate(array('s'=>'No carrier has been made available for this selection.','mod'=>'carriercompare'),$_smarty_tpl);?>
</p>
		<p class="SE_SubmitRefreshCard">
            <button class="btn btn-default button button-small" id="carriercompare_submit" type="submit" name="carriercompare_submit"><span><?php echo smartyTranslate(array('s'=>'Update cart','mod'=>'carriercompare'),$_smarty_tpl);?>
<i class="icon-chevron-right right"></i></span></button>
            <button id="update_carriers_list" type="button" class="btn btn-default button button-small"><span><?php echo smartyTranslate(array('s'=>'Update carrier list','mod'=>'carriercompare'),$_smarty_tpl);?>
<i class="icon-chevron-right right"></i></span></button>
