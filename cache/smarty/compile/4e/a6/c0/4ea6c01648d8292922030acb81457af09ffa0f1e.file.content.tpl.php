<?php /* Smarty version Smarty-3.1.14, created on 2014-01-06 14:21:54
         compiled from "C:\xampp\htdocs\e-commerce\admin\themes\default\template\controllers\login\content.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2528152caadf2565c37-72216167%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4ea6c01648d8292922030acb81457af09ffa0f1e' => 
    array (
      0 => 'C:\\xampp\\htdocs\\e-commerce\\admin\\themes\\default\\template\\controllers\\login\\content.tpl',
      1 => 1387468848,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2528152caadf2565c37-72216167',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52caadf27a7513_54727880',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52caadf27a7513_54727880')) {function content_52caadf27a7513_54727880($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\xampp\\htdocs\\e-commerce\\tools\\smarty\\plugins\\modifier.escape.php';
...
/icon-prestashop.svg"/>
			...
			<?php if (isset($_smarty_tpl->tpl_vars['errors']->value)){?>
				<h4>
					<?php if ($_smarty_tpl->tpl_vars['nbErrors']->value>1){?>
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input
									...
									id="email"
									class="form-control"
									value="<?php if (isset($_smarty_tpl->tpl_vars['email']->value)){?><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['email']->value, 'html', 'UTF-8');?>
<?php }?>"
									autofocus="autofocus"
									tabindex="1"
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input
									...
									id="passwd"
									class="form-control"
									value="<?php if (isset($_smarty_tpl->tpl_vars['password']->value)){?><?php echo $_smarty_tpl->tpl_vars['password']->value;?>
<?php }?>"
									tabindex="2"
									placeholder="<?php echo smartyTranslate(array('s'=>'Password'),$_smarty_tpl);?>
" />
							</div>
						</div>
...
"/>
			...
			<div class="alert alert-danger">
				...
				<p>
					<a href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['adminUrl']->value, 'html', 'UTF-8');?>
">
		...
		<div id="login-footer" class="animated fadeIn">
			<p class="text-center text-muted">
				<a href="http://www.prestashop.com/" onclick="return !window.open(this.href);">
					&copy; PrestaShop&#8482; 2005-<?php echo smarty_modifier_date_format(time(),"%Y");?>
 - All rights reserved
				</a>
			</p>
			<p class="text-center">
