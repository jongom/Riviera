<?php /* Smarty version Smarty-3.1.14, created on 2014-01-06 14:21:21
         compiled from "C:\xampp\htdocs\e-commerce\themes\default-bootstrap\order-carrier.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1223652caadd17abd66-93272690%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f5c68adb77042f55c2e97ccf83f9f8d1b29c890c' => 
    array (
      0 => 'C:\\xampp\\htdocs\\e-commerce\\themes\\default-bootstrap\\order-carrier.tpl',
      1 => 1387468850,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1223652caadd17abd66-93272690',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52caadd2813349_51821010',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52caadd2813349_51821010')) {function content_52caadd2813349_51821010($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\xampp\\htdocs\\e-commerce\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
<?php }?>
	...
	<?php if (!$_smarty_tpl->tpl_vars['opc']->value){?>
		...
		<form id="form" action="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,"multi-shipping=".((string)$_smarty_tpl->tpl_vars['multi_shipping']->value)), 'html', 'UTF-8');?>
" method="post" onsubmit="return acceptCGV();">
	...
	<?php }?>
			<div class="order_carrier_content box">
				...
				<?php }else{ ?>
					<p class="carrier_title"><?php echo smartyTranslate(array('s'=>'Choose your delivery method'),$_smarty_tpl);?>
</p>
														...
														<tr>
															<td class="delivery_option_radio">
																<input
																	...
																	type="radio"
																	name="delivery_option[<?php echo $_smarty_tpl->tpl_vars['id_address']->value;?>
]"
...
?>
							...
							<div id="extra_carrier" style="display: none;"></div>
								<?php if ($_smarty_tpl->tpl_vars['giftAllowed']->value){?>
									...
									<p id="gift_div" class="form-group">
										...
										<textarea rows="5" cols="35" id="gift_message" class="form-control" name="gift_message"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['cart']->value->gift_message, 'html', 'UTF-8');?>
</textarea>
									</p>
								<?php }?>
							<?php }?>
						...
						<?php if ($_smarty_tpl->tpl_vars['conditions']->value&&$_smarty_tpl->tpl_vars['cms_id']->value){?>
							...
							<p class="checkbox">
								...
								<a href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link_conditions']->value, 'html', 'UTF-8');?>
" class="iframe" rel="nofollow"><?php echo smartyTranslate(array('s'=>'(Read the Terms of Service)'),$_smarty_tpl);?>
					...
					<?php if (!$_smarty_tpl->tpl_vars['opc']->value){?>
							<div class="clearfix">
								<p><strong class="dark"><?php echo smartyTranslate(array('s'=>'Leave a message'),$_smarty_tpl);?>
</strong></p>
								<div class="form-group">
									...
									<textarea class="form-control" cols="120" rows="2" name="message" id="message"><?php if (isset($_smarty_tpl->tpl_vars['oldMessage']->value)){?><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['oldMessage']->value, 'html', 'UTF-8');?>
<?php }?></textarea>
								</div>
							</div>
...
" />
								<?php if (!$_smarty_tpl->tpl_vars['is_guest']->value){?>
									<?php if ($_smarty_tpl->tpl_vars['back']->value){?>
										<a 
											href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,"step=1&back=".((string)$_smarty_tpl->tpl_vars['back']->value)."&multi-shipping=".((string)$_smarty_tpl->tpl_vars['multi_shipping']->value)), 'html', 'UTF-8');?>
"
...
"
									...
									<?php }else{ ?>
										<a
											href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,"step=1&multi-shipping=".((string)$_smarty_tpl->tpl_vars['multi_shipping']->value)), 'html', 'UTF-8');?>
"
											title="<?php echo smartyTranslate(array('s'=>'Previous'),$_smarty_tpl);?>
"
											class="button-exclusive btn btn-default">
								...
								<?php }else{ ?>
									<a
										href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,"multi-shipping=".((string)$_smarty_tpl->tpl_vars['multi_shipping']->value)), 'html', 'UTF-8');?>
"
										title="<?php echo smartyTranslate(array('s'=>'Previous'),$_smarty_tpl);?>
"
										class="button-exclusive btn btn-default">
					...
					<?php }else{ ?>
							...
							<div>
								...
								<textarea class="form-control" cols="120" rows="2" name="message" id="message">
									<?php if (isset($_smarty_tpl->tpl_vars['oldMessage']->value)){?><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['oldMessage']->value, 'html', 'UTF-8');?>
<?php }?>
								</textarea>
							</div>
						</div> <!-- end opc_delivery_methods -->
					<?php }?>
	</div> <!-- end carrier_area --><?php }} ?>