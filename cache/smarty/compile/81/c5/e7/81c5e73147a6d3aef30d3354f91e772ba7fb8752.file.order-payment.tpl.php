<?php /* Smarty version Smarty-3.1.14, created on 2014-01-06 14:21:27
         compiled from "C:\xampp\htdocs\e-commerce\themes\default-bootstrap\order-payment.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2815052caadd7559342-04821302%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '81c5e73147a6d3aef30d3354f91e772ba7fb8752' => 
    array (
      0 => 'C:\\xampp\\htdocs\\e-commerce\\themes\\default-bootstrap\\order-payment.tpl',
      1 => 1387468850,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2815052caadd7559342-04821302',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52caadd8710320_85187151',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52caadd8710320_85187151')) {function content_52caadd8710320_85187151($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\xampp\\htdocs\\e-commerce\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
<?php }?>
									...
									<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value){?>
										...
										<?php }?>
										<tr class="cart_total_price">
											<td colspan="3" class="total_price_container text-right"><span><?php echo smartyTranslate(array('s'=>'Total'),$_smarty_tpl);?>
</span></td>
...
<?php $_tmp2=ob_get_clean();?><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&amp;id_product=".$_tmp1."&amp;ipa=".$_tmp2."&amp;id_customization=".((string)$_smarty_tpl->tpl_vars['id_customization']->value)."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), 'html', 'UTF-8');?>
"
																	rel="nofollow">
...
<?php $_tmp4=ob_get_clean();?><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"add=1&amp;id_product=".$_tmp3."&amp;ipa=".$_tmp4."&amp;id_customization=".((string)$_smarty_tpl->tpl_vars['id_customization']->value)."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), 'html', 'UTF-8');?>
"
																	rel="nofollow"
...
<?php $_tmp6=ob_get_clean();?><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"add=1&amp;id_product=".$_tmp5."&amp;ipa=".$_tmp6."&amp;id_customization=".((string)$_smarty_tpl->tpl_vars['id_customization']->value)."&amp;op=down&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), 'html', 'UTF-8');?>
"
																		rel="nofollow"
...
">
				...
				<?php if (!$_smarty_tpl->tpl_vars['opc']->value){?>
					<p class="cart_navigation clearfix">
						<a href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,"step=2"), 'html', 'UTF-8');?>
