<?php /* Smarty version Smarty-3.1.14, created on 2014-01-06 14:22:01
         compiled from "C:\xampp\htdocs\e-commerce\admin\themes\default\template\controllers\products\combinations.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2675152caadf94dc874-24879291%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '45a381a3853dfd915ef2d318968b766b31f997b7' => 
    array (
      0 => 'C:\\xampp\\htdocs\\e-commerce\\admin\\themes\\default\\template\\controllers\\products\\combinations.tpl',
      1 => 1387468848,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2675152caadf94dc874-24879291',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52caadf9d1c484_58970966',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52caadf9d1c484_58970966')) {function content_52caadf9d1c484_58970966($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\xampp\\htdocs\\e-commerce\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
"
	...
	<div class="alert alert-info">
		<?php echo smartyTranslate(array('s'=>'Or use the'),$_smarty_tpl);?>
&nbsp;<a class="btn btn-link bt-icon confirm_leave" href="index.php?tab=AdminAttributeGenerator&id_product=<?php echo $_smarty_tpl->tpl_vars['product']->value->id;?>
&attributegenerator&token=<?php echo $_smarty_tpl->tpl_vars['token_generator']->value;?>
"><i class="icon-magic"></i> <?php echo smartyTranslate(array('s'=>'Product combinations generator'),$_smarty_tpl);?>
 <i class="icon-external-link-sign"></i></a> <?php echo smartyTranslate(array('s'=>'in order to automatically create a set of combinations.'),$_smarty_tpl);?>

	</div>
	<?php if ($_smarty_tpl->tpl_vars['combination_exists']->value){?>
	<div class="alert alert-info" style="display:block">
		<?php echo smartyTranslate(array('s'=>'Some combinations already exist. If you want to generate new combinations, the quantities for the existing combinations will be lost.'),$_smarty_tpl);?>
<br/>
		<?php echo smartyTranslate(array('s'=>'You can add a combination by clicking the link "Add new combination" on the toolbar.'),$_smarty_tpl);?>
...
"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['attribute_group']->value['name'], 'html', 'UTF-8');?>
&nbsp;&nbsp;</option>
					<?php } ?>
				<?php }?>
				</select>
 ...
 .-_#">
		...
		<div class="form-group">
			<label class="control-label col-lg-3" for="attribute_wholesale_price">
				...
				<span class="label-tooltip" data-toggle="tooltip"
					title="<?php echo smartyTranslate(array('s'=>'Leave blank if the price does not change'),$_smarty_tpl);?>
">
...
<?php }?>
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="alert">
									<?php echo smartyTranslate(array('s'=>'final product price will be set to'),$_smarty_tpl);?>
...
<?php }?>
		...
		<div class="form-group">
			<label class="control-label col-lg-3" for="attribute_ecotax">
				...
				<span class="label-tooltip" data-toggle="tooltip"
					title="<?php echo smartyTranslate(array('s'=>'overrides Eco-tax in the "Information" tab'),$_smarty_tpl);?>
">
					<?php echo smartyTranslate(array('s'=>'Eco-tax (tax excl.):'),$_smarty_tpl);?>
...
" />
		...
		<div class="form-group">
			<label class="control-label col-lg-3" for="available_date_attribute">
				...
				<span class="label-tooltip" data-toggle="tooltip"
					title="<?php echo smartyTranslate(array('s'=>'The available date when this product is out of stock.'),$_smarty_tpl);?>
">
...
.jpg" alt="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['image']->value['legend'], 'html', 'UTF-8');?>
" title="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['image']->value['legend'], 'html', 'UTF-8');?>
" />
						</label>
					</li>
					<?php } ?>
