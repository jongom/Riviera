<?php /* Smarty version Smarty-3.1.14, created on 2014-01-06 14:21:10
         compiled from "C:\xampp\htdocs\e-commerce\themes\default-bootstrap\modules\blockwishlist\views\templates\front\mywishlist.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1337752caadc6030fd7-03080733%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1d5694fc8d0ade3438377a2b5010fb4dda45a71d' => 
    array (
      0 => 'C:\\xampp\\htdocs\\e-commerce\\themes\\default-bootstrap\\modules\\blockwishlist\\views\\templates\\front\\mywishlist.tpl',
      1 => 1387468850,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1337752caadc6030fd7-03080733',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52caadc6756604_52848715',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52caadc6756604_52848715')) {function content_52caadc6756604_52848715($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\xampp\\htdocs\\e-commerce\\tools\\smarty\\plugins\\modifier.escape.php';
...
</span><span class="navigation_page"><?php echo smartyTranslate(array('s'=>'My wishlists','mod'=>'blockwishlist'),$_smarty_tpl);?>
		...
		<form method="post" class="std box" id="form_wishlist">
			<fieldset>
				...
				<div class="form-group">
					<input type="hidden" name="token" value="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['token']->value, 'html', 'UTF-8');?>
" />
					<label class="align_right" for="name"><?php echo smartyTranslate(array('s'=>'Name','mod'=>'blockwishlist'),$_smarty_tpl);?>
</label>
					<input type="text" id="name" name="name" class="inputTxt form-control" value="<?php if (isset($_POST['name'])&&count($_smarty_tpl->tpl_vars['errors']->value)>0){?><?php echo smarty_modifier_escape($_POST['name'], 'html', 'UTF-8');?>
<?php }?>" />
				</div>
				<p class="submit">
                    <button type="submit" name="submitWishlist" id="submitWishlist" class="btn btn-default button button-medium"><span><?php echo smartyTranslate(array('s'=>'Save','mod'=>'blockwishlist'),$_smarty_tpl);?>
...
');"><?php echo smarty_modifier_escape($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate($_smarty_tpl->tpl_vars['wishlists']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['name'],30,'...'), 'html', 'UTF-8');?>
</a>
						</td>
...
');"><?php echo smartyTranslate(array('s'=>'View','mod'=>'blockwishlist'),$_smarty_tpl);?>
						...
						<td class="wishlist_delete">
							<a class="icon" href="javascript:;" onclick="return (WishlistDelete('wishlist_<?php echo intval($_smarty_tpl->tpl_vars['wishlists']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['id_wishlist']);?>
...
'));"><i class="icon-remove"></i></a>
	...
	<ul class="footer_links clearfix">
		<li><a class="btn btn-default button button-small" href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('my-account',true), 'html', 'UTF-8');?>
"><span><i class="icon-chevron-left"></i><?php echo smartyTranslate(array('s'=>'Back to Your Account','mod'=>'blockwishlist'),$_smarty_tpl);?>
</span></a></li>
		<li><a class="btn btn-default button button-small" href="<?php echo $_smarty_tpl->tpl_vars['base_dir']->value;?>
"><span><i class="icon-chevron-left"></i><?php echo smartyTranslate(array('s'=>'Home','mod'=>'blockwishlist'),$_smarty_tpl);?>
</span></a></li>
	</ul>
</div>
<?php }} ?>