<?php /* Smarty version Smarty-3.1.14, created on 2014-01-06 14:22:04
         compiled from "C:\xampp\htdocs\e-commerce\admin\themes\default\template\controllers\products\prices.tpl" */ ?>
<?php /*%%SmartyHeaderCode:435752caadfc7b3c06-32520479%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1bb64c13972893e5b5165124b6190e5a4fe47940' => 
    array (
      0 => 'C:\\xampp\\htdocs\\e-commerce\\admin\\themes\\default\\template\\controllers\\products\\prices.tpl',
      1 => 1387468848,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '435752caadfc7b3c06-32520479',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52caadfd3d5b13_85226161',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52caadfd3d5b13_85226161')) {function content_52caadfd3d5b13_85226161($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\xampp\\htdocs\\e-commerce\\tools\\smarty\\plugins\\modifier.escape.php';
?>
	...
	<div class="form-group">
		<label class="control-label col-lg-3" for="wholesale_price">
			...
			<span class="label-tooltip" data-toggle="tooltip"
				title="<?php echo smartyTranslate(array('s'=>'Wholesale price'),$_smarty_tpl);?>
">
...
" onchange="this.value = this.value.replace(/,/g, '.');" />
	...
	<div class="form-group">
		<label class="control-label col-lg-3" for="priceTE">
			...
			<span class="label-tooltip" data-toggle="tooltip"
				title="<?php echo smartyTranslate(array('s'=>'The pre-tax retail price to sell this product'),$_smarty_tpl);?>
">
...
" <?php if ($_smarty_tpl->tpl_vars['product']->value->getIdTaxRulesGroup()==$_smarty_tpl->tpl_vars['tax_rules_group']->value['id_tax_rules_group']){?>selected="selected"<?php }?> >
				...
				<div class="col-lg-2">
					<a class="btn btn-link confirm_leave" href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminTaxRulesGroup'), 'html', 'UTF-8');?>
...
" <?php if ($_smarty_tpl->tpl_vars['tax_exclude_taxe_option']->value){?>disabled="disabled"<?php }?>>
 ...
 :
				<a href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminTaxes'), 'html', 'UTF-8');?>
...
" name="id_tax_rules_group" />
	...
	<div class="form-group" <?php if (!$_smarty_tpl->tpl_vars['ps_use_ecotax']->value){?> style="display:none;"<?php }?>>
		<label class="control-label col-lg-3" for="ecotax">
			...
			<span class="label-tooltip" data-toggle="tooltip"
				title="<?php echo smartyTranslate(array('s'=>'already included in price'),$_smarty_tpl);?>
">
				<?php echo smartyTranslate(array('s'=>'Eco-tax (tax incl.):'),$_smarty_tpl);?>
...
<?php echo $_smarty_tpl->tpl_vars['currency']->value->suffix;?>
	...
	<div class="form-group">
		<label class="control-label col-lg-3" for="unit_price">
			...
			<span class="label-tooltip" data-toggle="tooltip"
				title="<?php echo smartyTranslate(array('s'=>'e.g. per lb.'),$_smarty_tpl);?>
">
