<?php /* Smarty version Smarty-3.1.14, created on 2014-01-06 14:21:48
         compiled from "C:\xampp\htdocs\e-commerce\admin\themes\default\template\controllers\attribute_generator\content.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2291552caadecc75392-58463674%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '146b4a1563f76170b27b9316091b6fabd7a8edf1' => 
    array (
      0 => 'C:\\xampp\\htdocs\\e-commerce\\admin\\themes\\default\\template\\controllers\\attribute_generator\\content.tpl',
      1 => 1387468848,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2291552caadecc75392-58463674',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52caaded0cd8e4_99171382',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52caaded0cd8e4_99171382')) {function content_52caaded0cd8e4_99171382($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\xampp\\htdocs\\e-commerce\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
" label="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['attribute_group']->value['name'], 'html', 'UTF-8');?>
">
...
" value="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['v']->value, 'html', 'UTF-8');?>
" title="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['v']->value, 'html', 'UTF-8');?>
"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['v']->value, 'html', 'UTF-8');?>
</option>
									<?php } ?>
								</optgroup>
							<?php }?>
 ...
 <b><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product_name']->value, 'html', 'UTF-8');?>
</b></div>
...
?>
					...
					<div class="row">
						<table class="table" style="display: none;">
							<thead>
								<tr>
									<th id="tab_h1" class="fixed-width-md"><span class="title_box"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['attribute_group']->value['name'], 'html', 'UTF-8');?>
</span></th>
				...
				<table class="table">
					<tbody>
						...
						<tr>
							...
							<td><input type="text" name="reference" value="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product_reference']->value, 'html', 'UTF-8');?>
" /></td>
						</tr>
					</tbody>
				</table>
