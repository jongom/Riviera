<?php /* Smarty version Smarty-3.1.14, created on 2014-01-06 14:21:10
         compiled from "C:\xampp\htdocs\e-commerce\themes\default-bootstrap\modules\cheque\views\templates\front\payment_execution.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2197252caadc6ed6712-27994497%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9938dd546d17b4d68b174c86964c859506289b5f' => 
    array (
      0 => 'C:\\xampp\\htdocs\\e-commerce\\themes\\default-bootstrap\\modules\\cheque\\views\\templates\\front\\payment_execution.tpl',
      1 => 1387468850,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2197252caadc6ed6712-27994497',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52caadc7453c95_11915892',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52caadc7453c95_11915892')) {function content_52caadc7453c95_11915892($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\xampp\\htdocs\\e-commerce\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
<?php }else{ ?>
    ...
    <form action="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getModuleLink('cheque','validation',array(),true), 'html', 'UTF-8');?>
" method="post">
    <div class="box cheque-box">
    	 <h3 class="page-subheading"><?php echo smartyTranslate(array('s'=>'Check payment','mod'=>'cheque'),$_smarty_tpl);?>
</h3>
        <p class="cheque-indent">
            <strong class="dark"><?php echo smartyTranslate(array('s'=>'You have chosen to pay by check.','mod'=>'cheque'),$_smarty_tpl);?>
...
" class="button-exclusive btn btn-default"><i class="icon-chevron-left"></i><?php echo smartyTranslate(array('s'=>'Other payment methods','mod'=>'cheque'),$_smarty_tpl);?>
</a>
            <button type="submit" class="button btn btn-default button-medium"><span><?php echo smartyTranslate(array('s'=>'I confirm my order','mod'=>'cheque'),$_smarty_tpl);?>
