<?php /* Smarty version Smarty-3.1.14, created on 2014-01-06 14:21:59
         compiled from "C:\xampp\htdocs\e-commerce\admin\themes\default\template\controllers\orders\_documents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1436452caadf7342996-84701759%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b6d563ec0a18797cc697ff3f99037552328e1ac2' => 
    array (
      0 => 'C:\\xampp\\htdocs\\e-commerce\\admin\\themes\\default\\template\\controllers\\orders\\_documents.tpl',
      1 => 1387468848,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1436452caadf7342996-84701759',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52caadf7b8a7f7_54398698',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52caadf7b8a7f7_54398698')) {function content_52caadf7b8a7f7_54398698($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\xampp\\htdocs\\e-commerce\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
" href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminPdf'), 'html', 'UTF-8');?>
...
<?php if (isset($_GET['token'])){?>&token=<?php echo smarty_modifier_escape($_GET['token'], 'html', 'UTF-8');?>
<?php }?>" method="post">
							<p>
...
" class="edit-note textarea-autosize"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['document']->value->note, 'html', 'UTF-8');?>
</textarea>
							</p>
							<p>
...
?>
			<tr>
				<td colspan="5" class="text-center">
					<i class="icon-warning-sign"></i> <?php echo smartyTranslate(array('s'=>'No documents are available'),$_smarty_tpl);?>

					<?php if (isset($_smarty_tpl->tpl_vars['invoice_management_active']->value)&&$_smarty_tpl->tpl_vars['invoice_management_active']->value){?>
						<a class="btn btn-link" href="<?php echo $_smarty_tpl->tpl_vars['current_index']->value;?>
