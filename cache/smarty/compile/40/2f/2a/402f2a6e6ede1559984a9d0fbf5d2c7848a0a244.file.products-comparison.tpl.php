<?php /* Smarty version Smarty-3.1.14, created on 2014-01-06 14:21:37
         compiled from "C:\xampp\htdocs\e-commerce\themes\default-bootstrap\products-comparison.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2889052caade1d3c9e0-11090457%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '402f2a6e6ede1559984a9d0fbf5d2c7848a0a244' => 
    array (
      0 => 'C:\\xampp\\htdocs\\e-commerce\\themes\\default-bootstrap\\products-comparison.tpl',
      1 => 1387468850,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2889052caade1d3c9e0-11090457',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52caade28a7728_92497264',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52caade28a7728_92497264')) {function content_52caade28a7728_92497264($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\xampp\\htdocs\\e-commerce\\tools\\smarty\\plugins\\modifier.escape.php';
...
?>
					...
					<td class="ajax_block_product comparison_infos product-block">
						<div class="remove">
							<a 
							class="cmp_remove" 
							href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('products-comparison',true), 'html', 'UTF-8');?>
" 
...
">
						...
						<div class="product-image-block">
							<a
							class="product_image" 
							href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value->getLink(), 'html', 'UTF-8');?>
" 
...
" />
						...
						<h5>
							...
							href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value->getLink(), 'html', 'UTF-8');?>
" 
							title="<?php echo smarty_modifier_escape($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate($_smarty_tpl->tpl_vars['product']->value->name,32,'...'), 'html', 'UTF-8');?>
">
...
%
 ...
 <?php echo smartyTranslate(array('s'=>'per %s','sprintf'=>smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value->unity, 'html', 'UTF-8')),$_smarty_tpl);?>
									...
									<span class="availability_value"<?php if ($_smarty_tpl->tpl_vars['product']->value->quantity<=0){?> class="warning-inline"<?php }?>>
										<?php if ($_smarty_tpl->tpl_vars['product']->value->quantity<=0){?>
											<?php if ($_smarty_tpl->tpl_vars['allow_oosp']->value){?>
												<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value->available_later, 'html', 'UTF-8');?>
											...
											<?php }?>
										<?php }else{ ?>
											<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value->available_now, 'html', 'UTF-8');?>
									...
									<?php if ((!$_smarty_tpl->tpl_vars['product']->value->hasAttributes()||(isset($_smarty_tpl->tpl_vars['add_prod_display']->value)&&($_smarty_tpl->tpl_vars['add_prod_display']->value==1)))&&$_smarty_tpl->tpl_vars['product']->value->minimal_quantity==1&&$_smarty_tpl->tpl_vars['product']->value->customizable!=2&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value){?>
										<?php if (($_smarty_tpl->tpl_vars['product']->value->quantity>0||$_smarty_tpl->tpl_vars['product']->value->allow_oosp)){?>
											<a
												...
												data-id-product="<?php echo $_smarty_tpl->tpl_vars['product']->value->id;?>
"
												href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"qty=1&amp;id_product=".((string)$_smarty_tpl->tpl_vars['product']->value->id)."&amp;token=".((string)$_smarty_tpl->tpl_vars['static_token']->value)."&amp;add"), 'html', 'UTF-8');?>
"
...
?>
 ...
 feature-name" >
							<strong><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['feature']->value['name'], 'html', 'UTF-8');?>
</strong>
						</td>
						<?php  $_smarty_tpl->tpl_vars['product'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['product']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['products']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
							...
							<?php if (isset($_smarty_tpl->tpl_vars['product_features']->value[$_smarty_tpl->tpl_vars['product_id']->value])){?>
								...
								<td class="<?php echo $_smarty_tpl->tpl_vars['classname']->value;?>
 comparison_infos"><?php if ((isset($_smarty_tpl->tpl_vars['tab']->value[$_smarty_tpl->tpl_vars['feature_id']->value]))){?><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['tab']->value[$_smarty_tpl->tpl_vars['feature_id']->value], 'html', 'UTF-8');?>
<?php }?></td>
							<?php }else{ ?>
								<td class="<?php echo $_smarty_tpl->tpl_vars['classname']->value;?>
 comparison_infos"></td>
