<?php /* Smarty version Smarty-3.1.14, created on 2014-01-06 14:22:16
         compiled from "C:\xampp\htdocs\e-commerce\admin\themes\default\template\helpers\list\list_content.tpl" */ ?>
<?php /*%%SmartyHeaderCode:28952caae081e0e45-91435503%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bbf6593fa4de597df7ca87baa818132fcc515613' => 
    array (
      0 => 'C:\\xampp\\htdocs\\e-commerce\\admin\\themes\\default\\template\\helpers\\list\\list_content.tpl',
      1 => 1387468848,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '28952caae081e0e45-91435503',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52caae09471cf1_43485096',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52caae09471cf1_43485096')) {function content_52caae09471cf1_43485096($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\xampp\\htdocs\\e-commerce\\tools\\smarty\\plugins\\modifier.escape.php';
				...
				<?php if (isset($_smarty_tpl->tpl_vars['tr']->value[$_smarty_tpl->tpl_vars['key']->value])){?>
					...
					<?php }elseif(isset($_smarty_tpl->tpl_vars['params']->value['activeVisu'])){?>
						<?php if ($_smarty_tpl->tpl_vars['tr']->value[$_smarty_tpl->tpl_vars['key']->value]){?>
							<span class="label label-success"><i class="icon-check-sign"></i> <?php echo smartyTranslate(array('s'=>'Enabled'),$_smarty_tpl);?>
</span>
						<?php }else{ ?>
							<span class="label label-warning"><i class="icon-ban-circle"></i> <?php echo smartyTranslate(array('s'=>'Disabled'),$_smarty_tpl);?>
</span>
						<?php }?>
...
<?php } ?>
<?php }else{ ?>
	<tr><td class="center text-muted" colspan="<?php echo count($_smarty_tpl->tpl_vars['fields_display']->value)+2;?>
