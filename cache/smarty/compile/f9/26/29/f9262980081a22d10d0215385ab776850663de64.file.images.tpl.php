<?php /* Smarty version Smarty-3.1.14, created on 2014-01-06 14:22:03
         compiled from "C:\xampp\htdocs\e-commerce\admin\themes\default\template\controllers\products\images.tpl" */ ?>
<?php /*%%SmartyHeaderCode:539552caadfb152645-13396164%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f9262980081a22d10d0215385ab776850663de64' => 
    array (
      0 => 'C:\\xampp\\htdocs\\e-commerce\\admin\\themes\\default\\template\\controllers\\products\\images.tpl',
      1 => 1387468848,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '539552caadfb152645-13396164',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52caadfb569c87_87442729',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52caadfb569c87_87442729')) {function content_52caadfb569c87_87442729($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\xampp\\htdocs\\e-commerce\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
">
				<?php if (isset($_smarty_tpl->tpl_vars['id_image']->value)){?><?php echo smartyTranslate(array('s'=>'Edit this product image:'),$_smarty_tpl);?>
...
<?php }?>
 ...
 <>;=#{}">
				<?php echo smartyTranslate(array('s'=>'Legend:'),$_smarty_tpl);?>
...
"
					value="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value->name[$_smarty_tpl->tpl_vars['language']->value['id_lang']], 'html', 'UTF-8');?>
"
...
<table class="table tableDnD" id="imageTable">
	<thead>
		<tr class="nodrag nodrop"> 
			<th class="fixed-width-sm"><span class="title_box"><?php echo smartyTranslate(array('s'=>'Image'),$_smarty_tpl);?>
</span></th>
			<th class="fixed-width-lg"><span class="title_box"><?php echo smartyTranslate(array('s'=>'Legend'),$_smarty_tpl);?>
</span></th>
			<th class="center fixed-width-xs"><span class="title_box"><?php echo smartyTranslate(array('s'=>'Position'),$_smarty_tpl);?>
</span></th>
...
?>
				<th class="center fixed-width-xs"><span class="title_box"><?php echo $_smarty_tpl->tpl_vars['shop']->value['name'];?>
</span></th>
			<?php } ?>
			<?php }?>
			<th class="center fixed-width-xs"><span class="title_box"><?php echo smartyTranslate(array('s'=>'Cover'),$_smarty_tpl);?>
</span></th>
			<th></th>
		</tr>
	</thead>
