<?php /* Smarty version Smarty-3.1.14, created on 2014-01-06 14:20:24
         compiled from "C:\xampp\htdocs\e-commerce\themes\default-bootstrap\mobile\authentication-choice.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1508852caad9805e130-98873036%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7ab6123fd6e14b29f0e834b8ea8faa69100b7396' => 
    array (
      0 => 'C:\\xampp\\htdocs\\e-commerce\\themes\\default-bootstrap\\mobile\\authentication-choice.tpl',
      1 => 1387468850,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1508852caad9805e130-98873036',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52caad9824cd58_93538567',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52caad9824cd58_93538567')) {function content_52caad9824cd58_93538567($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\xampp\\htdocs\\e-commerce\\tools\\smarty\\plugins\\modifier.escape.php';
...
" name="email_create" value="<?php if (isset($_POST['email_create'])){?><?php echo stripslashes(smarty_modifier_escape($_POST['email_create'], 'html', 'UTF-8'));?>
...
" value="<?php if (isset($_POST['email'])){?><?php echo stripslashes(smarty_modifier_escape($_POST['email'], 'html', 'UTF-8'));?>
...
" value="<?php if (isset($_POST['passwd'])){?><?php echo stripslashes(smarty_modifier_escape($_POST['passwd'], 'html', 'UTF-8'));?>
<?php }?>" class="account_input" />
