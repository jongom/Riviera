<?php /* Smarty version Smarty-3.1.14, created on 2014-01-06 14:21:28
         compiled from "C:\xampp\htdocs\e-commerce\themes\default-bootstrap\order-return.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3019952caadd8753ec8-53266694%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '361164ebb1bd1a741892830cc0a8b0df94e78e80' => 
    array (
      0 => 'C:\\xampp\\htdocs\\e-commerce\\themes\\default-bootstrap\\order-return.tpl',
      1 => 1387468850,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3019952caadd8753ec8-53266694',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52caadd91b6235_11781539',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52caadd91b6235_11781539')) {function content_52caadd91b6235_11781539($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\xampp\\htdocs\\e-commerce\\tools\\smarty\\plugins\\modifier.escape.php';
...
<?php echo sprintf("%06d",$_smarty_tpl->tpl_vars['orderRet']->value->id);?>
 ...
 <span class="bold"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['state_name']->value, 'html', 'UTF-8');?>
</span></p>
...
?>
					<?php if ($_smarty_tpl->tpl_vars['customization']->value['product_id']==$_smarty_tpl->tpl_vars['product']->value['product_id']){?>
						<tr class="<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['products']['first']){?>first_item<?php }?> <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['products']['index']%2){?>alternate_item<?php }else{ ?>item<?php }?>">
							<td><?php if ($_smarty_tpl->tpl_vars['customization']->value['reference']){?><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['customization']->value['reference'], 'html', 'UTF-8');?>
<?php }else{ ?>--<?php }?></td>
							<td class="bold"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['customization']->value['name'], 'html', 'UTF-8');?>
</td>
...
?>
 ...
 <?php echo $_smarty_tpl->tpl_vars['data']->value['value'];?>
				...
				<?php if ($_smarty_tpl->tpl_vars['product']->value['product_quantity']>$_smarty_tpl->tpl_vars['quantityDisplayed']->value){?>
					<tr class="<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['products']['first']){?>first_item<?php }?> <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['products']['index']%2){?>alternate_item<?php }else{ ?>item<?php }?>">
						<td><?php if ($_smarty_tpl->tpl_vars['product']->value['product_reference']){?><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value['product_reference'], 'html', 'UTF-8');?>
<?php }else{ ?>--<?php }?></td>
						<td class="bold"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value['product_name'], 'html', 'UTF-8');?>
</td>
...
<?php $_tmp1=ob_get_clean();?><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('pdf-order-return',true,null,"id_order_return=".$_tmp1), 'html', 'UTF-8');?>
"><?php echo smartyTranslate(array('s'=>'PDF return slip'),$_smarty_tpl);?>
 ...
 (<a href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['orderRet']->value->id);?>
<?php $_tmp2=ob_get_clean();?><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('pdf-order-return',true,null,"id_order_return=".$_tmp2), 'html', 'UTF-8');?>
"><?php echo smartyTranslate(array('s'=>'for the correct address'),$_smarty_tpl);?>
		...
		<br /><br /><a href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('contact',true), 'html', 'UTF-8');?>
