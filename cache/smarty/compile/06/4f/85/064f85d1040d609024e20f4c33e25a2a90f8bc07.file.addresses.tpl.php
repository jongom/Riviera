<?php /* Smarty version Smarty-3.1.14, created on 2014-01-06 14:20:09
         compiled from "C:\xampp\htdocs\e-commerce\themes\default-bootstrap\addresses.tpl" */ ?>
<?php /*%%SmartyHeaderCode:660352caad897f33f4-31293006%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '064f85d1040d609024e20f4c33e25a2a90f8bc07' => 
    array (
      0 => 'C:\\xampp\\htdocs\\e-commerce\\themes\\default-bootstrap\\addresses.tpl',
      1 => 1387468850,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '660352caad897f33f4-31293006',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52caad89f1be35_50950878',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52caad89f1be35_50950878')) {function content_52caad89f1be35_50950878($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\xampp\\htdocs\\e-commerce\\tools\\smarty\\plugins\\modifier.escape.php';
...
"<?php }?>>
                            <?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['address']->value['formated'][smarty_modifier_replace($_smarty_tpl->tpl_vars['key']->value,',','')], 'html', 'UTF-8');?>
...
<?php $_tmp1=ob_get_clean();?><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,null,"id_address=".$_tmp1), 'html', 'UTF-8');?>
...
<i class="icon-chevron-right right"></i></span></a>
                <a class="btn btn-default button button-small" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['address']->value['object']['id']);?>
<?php $_tmp2=ob_get_clean();?><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,null,"id_address=".$_tmp2."&delete"), 'html', 'UTF-8');?>
...
&nbsp;<a href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true), 'html', 'UTF-8');?>
...
<ul class="footer_links clearfix">
	<li><a class="btn btn-defaul button button-small" href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('my-account',true), 'html', 'UTF-8');?>
