<?php /* Smarty version Smarty-3.1.14, created on 2014-01-06 14:21:19
         compiled from "C:\xampp\htdocs\e-commerce\themes\default-bootstrap\order-address-multishipping.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2287352caadcf1e3c66-78244910%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '32ce73de475664fc8cb44b0d48f080d55091aabc' => 
    array (
      0 => 'C:\\xampp\\htdocs\\e-commerce\\themes\\default-bootstrap\\order-address-multishipping.tpl',
      1 => 1387468850,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2287352caadcf1e3c66-78244910',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52caadcf8fa3a8_33507888',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52caadcf8fa3a8_33507888')) {function content_52caadcf8fa3a8_33507888($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\xampp\\htdocs\\e-commerce\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
"
	...
	{
		return {
			'invoice': "<h3 class='page-subheading'><?php echo smartyTranslate(array('s'=>'Your billing address'),$_smarty_tpl);?>
</h3>",
			'delivery': "<h3 class='page-subheading'><?php echo smartyTranslate(array('s'=>'Your delivery address'),$_smarty_tpl);?>
</h3>"
		};
	...
	function buildAddressBlock(id_address, address_type, dest_comp)
	{
		...
		li_content['update'] = '<a class="btn btn-default button button-small" href="<?php echo addslashes($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,null,"id_address"));?>
...
<?php if (!$_smarty_tpl->tpl_vars['opc']->value){?><h1 class="page-heading"><?php echo smartyTranslate(array('s'=>'Addresses'),$_smarty_tpl);?>
</h1><?php }else{ ?><h1 class="page-heading step-num"><span>1</span> <?php echo smartyTranslate(array('s'=>'Addresses'),$_smarty_tpl);?>
</h1><?php }?>
...
<form action="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,'multi-shipping=1'), 'html', 'UTF-8');?>
" method="post">
<?php }else{ ?>
...
<?php $_tmp1=ob_get_clean();?><?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['back']->value){?><?php echo "&mod=";?><?php echo (string)$_smarty_tpl->tpl_vars['back']->value;?><?php }?><?php $_tmp2=ob_get_clean();?><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,null,"back=".((string)$_smarty_tpl->tpl_vars['back_order_page']->value)."?step=1".$_tmp1.$_tmp2), 'html', 'UTF-8');?>
...
<?php }?><?php $_tmp4=ob_get_clean();?><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,null,"back=".((string)$_smarty_tpl->tpl_vars['back_order_page']->value)."?step=1".$_tmp3.$_tmp4), 'html', 'UTF-8');?>
" title="<?php echo smartyTranslate(array('s'=>'Add'),$_smarty_tpl);?>
" class="button button-small btn btn-default"><span><?php echo smartyTranslate(array('s'=>'Add a new address'),$_smarty_tpl);?>
<i class="icon-chevron-right right"></i></span></a>
		</p>
...
" />
		<?php if ($_smarty_tpl->tpl_vars['back']->value){?>
			<a href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,"step=0&amp;back=".((string)$_smarty_tpl->tpl_vars['back']->value)), 'html', 'UTF-8');?>
...
" class="button-exclusive btn btn-default"><i class="icon-chevron-left"></i><?php echo smartyTranslate(array('s'=>'Continue Shopping'),$_smarty_tpl);?>
		...
		<?php }else{ ?>
			<a href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,"step=0"), 'html', 'UTF-8');?>
" title="<?php echo smartyTranslate(array('s'=>'Previous'),$_smarty_tpl);?>
" class="button-exclusive btn btn-default"><i class="icon-chevron-left"></i><?php echo smartyTranslate(array('s'=>'Continue Shopping'),$_smarty_tpl);?>
</a>
		<?php }?>
