<?php /* Smarty version Smarty-3.1.14, created on 2014-01-06 14:21:15
         compiled from "C:\xampp\htdocs\e-commerce\themes\default-bootstrap\modules\referralprogram\views\templates\front\program.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1014052caadcb8e2800-01457073%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0ada43cde15a62b2a8ee4e37d61456b9690adfde' => 
    array (
      0 => 'C:\\xampp\\htdocs\\e-commerce\\themes\\default-bootstrap\\modules\\referralprogram\\views\\templates\\front\\program.tpl',
      1 => 1387468850,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1014052caadcb8e2800-01457073',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52caadcc8f7838_98829658',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52caadcc8f7838_98829658')) {function content_52caadcc8f7838_98829658($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\xampp\\htdocs\\e-commerce\\tools\\smarty\\plugins\\modifier.escape.php';
?>

<script type="text/javascript">
// <![CDATA[
	ThickboxI18nClose = "<?php echo smartyTranslate(array('s'=>'Close','mod'=>'referralprogram'),$_smarty_tpl);?>
";
	ThickboxI18nOrEscKey = "<?php echo smartyTranslate(array('s'=>'or Esc key','mod'=>'referralprogram'),$_smarty_tpl);?>
";
	tb_pathToImage = "<?php echo $_smarty_tpl->tpl_vars['img_ps_dir']->value;?>
loadingAnimation.gif";
	//]]>
</script>

<?php $_smarty_tpl->_capture_stack[0][] = array('path', null, null); ob_start(); ?><a href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getPageLink('my-account',true), 'html', 'UTF-8');?>
...
<div class="sheets tab-content">
	...
	<div id="idTab1" class="tab-pane active">
		<p class="bold">
			<strong><?php echo smartyTranslate(array('s'=>'Get a discount of %1$d %2$s for you and your friends by recommending this Website.','sprintf'=>array($_smarty_tpl->tpl_vars['discount']->value,$_smarty_tpl->tpl_vars['currencySign']->value),'mod'=>'referralprogram'),$_smarty_tpl);?>
</strong>
		</p>
		<?php if ($_smarty_tpl->tpl_vars['canSendInvitations']->value){?>
			<p>
				...
				<?php }?>,
				<?php echo smartyTranslate(array('s'=>'he or she will receive a %1$d %2$s voucher and you will receive your own voucher worth %3$d %4$s.','sprintf'=>array($_smarty_tpl->tpl_vars['discount']->value,$_smarty_tpl->tpl_vars['currencySign']->value,$_smarty_tpl->tpl_vars['discount']->value,$_smarty_tpl->tpl_vars['currencySign']->value),'mod'=>'referralprogram'),$_smarty_tpl);?>

			</p>
			<form method="post" action="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getModuleLink('referralprogram','program',array(),true), 'html', 'UTF-8');?>
" class="std">
...
]" size="14" value="<?php if (isset($_POST['friendsLastName'][$_smarty_tpl->getVariable('smarty',null,true,false)->value['section']['friends']['index']])){?><?php echo smarty_modifier_escape($_POST['friendsLastName'][$_smarty_tpl->getVariable('smarty')->value['section']['friends']['index']], 'html', 'UTF-8');?>
<?php }?>" /></td>
...
]" size="14" value="<?php if (isset($_POST['friendsFirstName'][$_smarty_tpl->getVariable('smarty',null,true,false)->value['section']['friends']['index']])){?><?php echo smarty_modifier_escape($_POST['friendsFirstName'][$_smarty_tpl->getVariable('smarty')->value['section']['friends']['index']], 'html', 'UTF-8');?>
<?php }?>" /></td>
...
]" size="20" value="<?php if (isset($_POST['friendsEmail'][$_smarty_tpl->getVariable('smarty',null,true,false)->value['section']['friends']['index']])){?><?php echo smarty_modifier_escape($_POST['friendsEmail'][$_smarty_tpl->getVariable('smarty')->value['section']['friends']['index']], 'html', 'UTF-8');?>
<?php }?>" /></td>
					</tr>
					<?php endfor; endif; ?>
				</tbody>
				...
				<p class="checkbox">
					...
					<a href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getModuleLink('referralprogram','rules',array('height'=>'500','width'=>'400'),true), 'html', 'UTF-8');?>
...
<?php $_tmp1=ob_get_clean();?><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getModuleLink('referralprogram','email',array('height'=>'500','width'=>'600','mail'=>$_tmp1),true), 'html', 'UTF-8');?>
