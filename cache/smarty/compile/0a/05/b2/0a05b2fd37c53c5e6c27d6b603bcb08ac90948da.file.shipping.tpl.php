<?php /* Smarty version Smarty-3.1.14, created on 2014-01-06 14:22:05
         compiled from "C:\xampp\htdocs\e-commerce\admin\themes\default\template\controllers\products\shipping.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2365652caadfdbe08e6-97992193%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0a05b2fd37c53c5e6c27d6b603bcb08ac90948da' => 
    array (
      0 => 'C:\\xampp\\htdocs\\e-commerce\\admin\\themes\\default\\template\\controllers\\products\\shipping.tpl',
      1 => 1387468848,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2365652caadfdbe08e6-97992193',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52caadfde86166_71383582',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52caadfde86166_71383582')) {function content_52caadfde86166_71383582($_smarty_tpl) {?>
<div id="product-shipping" class="panel product-tab">
 ...
 <?php echo smartyTranslate(array('s'=>'Width (package):'),$_smarty_tpl);?>
</label>
...
" onKeyUp="if (isArrowKey(event)) return ;this.value = this.value.replace(/,/g, '.');" />			
 ...
 <?php echo smartyTranslate(array('s'=>'Height (package):'),$_smarty_tpl);?>
</label>
		<div class="input-group col-lg-2">
			<span class="input-group-addon"><?php echo $_smarty_tpl->tpl_vars['ps_dimension_unit']->value;?>
</span>
...
" onKeyUp="if (isArrowKey(event)) return ;this.value = this.value.replace(/,/g, '.');" />
 ...
 <?php echo smartyTranslate(array('s'=>'Depth (package):'),$_smarty_tpl);?>
</label>
		<div class="input-group col-lg-2">
			<span class="input-group-addon"><?php echo $_smarty_tpl->tpl_vars['ps_dimension_unit']->value;?>
</span>
...
" onKeyUp="if (isArrowKey(event)) return ;this.value = this.value.replace(/,/g, '.');" />
 ...
 <?php echo smartyTranslate(array('s'=>'Weight (package):'),$_smarty_tpl);?>
</label>
		<div class="input-group col-lg-2">
	...
	<div class="form-group">
		<label class="control-label col-lg-3" for="additional_shipping_cost">
			<span class="label-tooltip" data-toggle="tooltip"
				title="<?php echo smartyTranslate(array('s'=>'A carrier tax will be applied.'),$_smarty_tpl);?>
">
				<?php echo smartyTranslate(array('s'=>'Additional shipping cost (per quantity):'),$_smarty_tpl);?>
