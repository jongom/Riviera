<?php /* Smarty version Smarty-3.1.14, created on 2014-01-06 14:21:57
         compiled from "C:\xampp\htdocs\e-commerce\admin\themes\default\template\controllers\orders\form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:30752caadf5be2953-45385494%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dcf3a2ccef697386a4e064142de195c2f9876519' => 
    array (
      0 => 'C:\\xampp\\htdocs\\e-commerce\\admin\\themes\\default\\template\\controllers\\orders\\form.tpl',
      1 => 1387468848,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '30752caadf5be2953-45385494',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52caadf6721e75_24643313',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52caadf6721e75_24643313')) {function content_52caadf6721e75_24643313($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\xampp\\htdocs\\e-commerce\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
" class="duplicate_order btn btn-default" rel="'+this.id_order+'"><i class="icon-arrow-right"></i>&nbsp;<?php echo smartyTranslate(array('s'=>"Utiliser"),$_smarty_tpl);?>
</a>';
						html_orders += '</td>';
						html_orders += '</tr>';
					});
			...
			success : function(res)
			{
				...
				if(res.found)
				{
					...
					$.each(res.products, function() {
						...
						{
							customization_html += '<div class="panel"><h3><?php echo smartyTranslate(array('s'=>'Customization'),$_smarty_tpl);?>
	...
	<div class="panel form-horizontal" id="customer_part">
		...
		<div id="search-customer-form-group" class="form-group ">
			<label class="control-label col-lg-3">
				<span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="<?php echo smartyTranslate(array('s'=>'Search a customer by typping the first letters of his/her name'),$_smarty_tpl);?>
">
					<?php echo smartyTranslate(array('s'=>'Search customers'),$_smarty_tpl);?>
...
&nbsp;</span>
						<a class="fancybox btn btn-default" href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminCustomers'), 'html', 'UTF-8');?>
...
<form class="form-horizontal" action="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminOrders'), 'html', 'UTF-8');?>
...
=1" method="post" autocomplete="off">
	<div class="panel" id="products_part" style="display:none;">
		...
		<div class="form-group">
			<label class="control-label col-lg-3">
				<span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="<?php echo smartyTranslate(array('s'=>'Search a product by typping the first letters of his/her name.'),$_smarty_tpl);?>
">
				...
				<table class="table" id="customer_cart">
					<thead>
						<tr>
							...
							<th><span class="title_box"><?php echo smartyTranslate(array('s'=>'Ref'),$_smarty_tpl);?>
</span></th>
							<th><span class="title_box"><?php echo smartyTranslate(array('s'=>'Unit price'),$_smarty_tpl);?>
</span></th>
							<th><span class="title_box"><?php echo smartyTranslate(array('s'=>'Qty'),$_smarty_tpl);?>
</span></th>
			...
			<div class="col-lg-9">
				<div class="row">
					...
					<div class="col-lg-6">
						<span class="form-control-static"><?php echo smartyTranslate(array('s'=>'Or'),$_smarty_tpl);?>
&nbsp;</span>
						<a class="fancybox btn btn-default" href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminCartRules'), 'html', 'UTF-8');?>
&addcart_rule&liteDisplaying=1&submitFormAjax=1#">
	...
	<div class="panel" id="address_part" style="display:none;">
		...
		<div class="row">
			<div class="col-lg-12">
				<a class="fancybox btn btn-default" id="new_address" href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminAddresses'), 'html', 'UTF-8');?>
