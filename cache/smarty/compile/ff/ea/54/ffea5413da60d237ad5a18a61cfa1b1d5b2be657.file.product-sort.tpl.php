<?php /* Smarty version Smarty-3.1.14, created on 2014-01-06 14:21:33
         compiled from "C:\xampp\htdocs\e-commerce\themes\default-bootstrap\product-sort.tpl" */ ?>
<?php /*%%SmartyHeaderCode:921252caaddd7f3331-44046115%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ffea5413da60d237ad5a18a61cfa1b1d5b2be657' => 
    array (
      0 => 'C:\\xampp\\htdocs\\e-commerce\\themes\\default-bootstrap\\product-sort.tpl',
      1 => 1387468850,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '921252caaddd7f3331-44046115',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52caadddb8f940_97892440',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52caadddb8f940_97892440')) {function content_52caadddb8f940_97892440($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\xampp\\htdocs\\e-commerce\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
<ul class="display hidden-xs">
    ...
    <li id="grid"><a onclick="display('grid');"><i class="icon-th-large"></i><?php echo smartyTranslate(array('s'=>'Grid'),$_smarty_tpl);?>
</a></li>
    <li id="list"><a onclick="display('list');"><i class="icon-th-list"></i><?php echo smartyTranslate(array('s'=>'List'),$_smarty_tpl);?>
</a></li>
</ul>
...
<?php }?>" action="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['request']->value, 'html', 'UTF-8');?>
...
<?php }?>" class="selectProductSort form-control">
			<option value="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['orderbydefault']->value, 'html', 'UTF-8');?>
:<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['orderwaydefault']->value, 'html', 'UTF-8');?>
