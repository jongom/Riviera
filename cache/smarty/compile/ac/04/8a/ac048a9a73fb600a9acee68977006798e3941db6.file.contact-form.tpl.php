<?php /* Smarty version Smarty-3.1.14, created on 2014-01-06 14:20:27
         compiled from "C:\xampp\htdocs\e-commerce\themes\default-bootstrap\mobile\contact-form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:864652caad9b882f46-64213453%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ac048a9a73fb600a9acee68977006798e3941db6' => 
    array (
      0 => 'C:\\xampp\\htdocs\\e-commerce\\themes\\default-bootstrap\\mobile\\contact-form.tpl',
      1 => 1387468850,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '864652caad9b882f46-64213453',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52caad9c1a5771_62313296',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52caad9c1a5771_62313296')) {function content_52caad9c1a5771_62313296($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\xampp\\htdocs\\e-commerce\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
?>
					<?php if ($_smarty_tpl->tpl_vars['contact']->value['id_contact']==$_smarty_tpl->tpl_vars['customerThread']->value['id_contact']){?>
						<input type="text" id="contact_name" name="contact_name" value="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['contact']->value['name'], 'html', 'UTF-8');?>
" readonly="readonly" />
...
" <?php if (isset($_POST['id_contact'])&&$_POST['id_contact']==$_smarty_tpl->tpl_vars['contact']->value['id_contact']){?>selected="selected"<?php }?>><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['contact']->value['name'], 'html', 'UTF-8');?>
</option>
				<?php } ?>
				</select>
...
" class="desc_contact" style="display:none;">
						<label>&nbsp;</label><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['contact']->value['description'], 'html', 'UTF-8');?>
...
" rows="15" cols="10"><?php if (isset($_smarty_tpl->tpl_vars['message']->value)&&$_smarty_tpl->tpl_vars['message']->value!=''){?><?php echo stripslashes(smarty_modifier_escape($_smarty_tpl->tpl_vars['message']->value, 'html', 'UTF-8'));?>
<?php }?></textarea>
			</fieldset>
