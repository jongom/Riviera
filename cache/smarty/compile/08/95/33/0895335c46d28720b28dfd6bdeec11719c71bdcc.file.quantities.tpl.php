<?php /* Smarty version Smarty-3.1.14, created on 2014-01-06 14:22:05
         compiled from "C:\xampp\htdocs\e-commerce\admin\themes\default\template\controllers\products\quantities.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3004252caadfd412107-59017845%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0895335c46d28720b28dfd6bdeec11719c71bdcc' => 
    array (
      0 => 'C:\\xampp\\htdocs\\e-commerce\\admin\\themes\\default\\template\\controllers\\products\\quantities.tpl',
      1 => 1387468848,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3004252caadfd412107-59017845',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52caadfd8ccb09_66523231',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52caadfd8ccb09_66523231')) {function content_52caadfd8ccb09_66523231($_smarty_tpl) {?>
				...
				<div class="form-group" <?php if ($_smarty_tpl->tpl_vars['product']->value->is_virtual||$_smarty_tpl->tpl_vars['product']->value->cache_is_pack){?>style="display:none;"<?php }?> class="row stockForVirtualProduct">
					<div class="col-lg-9 col-lg-offset-3">
						<p class="checkbox">
							...
							<?php if ($_smarty_tpl->tpl_vars['stock_management_active']->value==0&&!$_smarty_tpl->tpl_vars['product']->value->cache_is_pack){?>
								<p class="text-info"><i class="icon-info-sign"></i>&nbsp;<?php echo smartyTranslate(array('s'=>'This requires you to enable advanced stock management.'),$_smarty_tpl);?>
</p>
							<?php }elseif($_smarty_tpl->tpl_vars['product']->value->cache_is_pack){?>
								<p class="text-info"><?php echo smartyTranslate(array('s'=>'This parameter depends on the product(s) in the pack.'),$_smarty_tpl);?>
</p>
							<?php }?>
					</div>
				</div>

				<div <?php if ($_smarty_tpl->tpl_vars['product']->value->is_virtual||$_smarty_tpl->tpl_vars['product']->value->cache_is_pack){?>style="display:none;"<?php }?> class="row stockForVirtualProduct">
...
">
	...
	<div class="panel">
		...
		<?php if (!$_smarty_tpl->tpl_vars['has_attribute']->value){?>
			<div class="form-group">
				<label class="control-label col-lg-3" for="minimal_quantity"><?php echo smartyTranslate(array('s'=>'Minimum quantity:'),$_smarty_tpl);?>
</label>
				<div class="col-lg-9">
...
">
					...
					<span class="label-tooltip" data-toggle="tooltip"
						title="<?php echo smartyTranslate(array('s'=>'Forbidden characters:'),$_smarty_tpl);?>
 &#60;&#62;;&#61;#&#123;&#125;">
						<?php echo smartyTranslate(array('s'=>'Displayed text when back-ordereding is allowed:'),$_smarty_tpl);?>
			...
			<div class="form-group">
				<label class="control-label col-lg-3" for="available_date"><?php echo smartyTranslate(array('s'=>'Available date:'),$_smarty_tpl);?>
</label>
				<div class="col-lg-9">
...
<script type="text/javascript">
	hideOtherLanguage(<?php echo $_smarty_tpl->tpl_vars['default_language']->value;?>
);
</script><?php }} ?>