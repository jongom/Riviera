<?php /* Smarty version Smarty-3.1.14, created on 2014-01-06 14:22:11
         compiled from "C:\xampp\htdocs\e-commerce\admin\themes\default\template\helpers\form\form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1162852caae03ab33a9-94633778%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c0e832497cce997206ad1a29cfe666f458017f26' => 
    array (
      0 => 'C:\\xampp\\htdocs\\e-commerce\\admin\\themes\\default\\template\\helpers\\form\\form.tpl',
      1 => 1387468848,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1162852caae03ab33a9-94633778',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52caae06852f77_43939640',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52caae06852f77_43939640')) {function content_52caae06852f77_43939640($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\xampp\\htdocs\\e-commerce\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
?>
						...
						<div class="form-group <?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='hidden'){?>hide<?php }?>" <?php if ($_smarty_tpl->tpl_vars['input']->value['name']=='id_state'){?>id="contains_states"<?php if (!$_smarty_tpl->tpl_vars['contains_states']->value){?>style="display:none;"<?php }?><?php }?>>
...
"<?php }?>
								>
								<?php if (isset($_smarty_tpl->tpl_vars['field']->value['icon'])){?><i class="<?php echo $_smarty_tpl->tpl_vars['field']->value['icon'];?>
"></i><?php }?> <?php echo $_smarty_tpl->tpl_vars['field']->value['title'];?>

							</button>
							<?php if (isset($_smarty_tpl->tpl_vars['field']->value['reset'])){?>
							<button
								type="reset"
								id="<?php if (isset($_smarty_tpl->tpl_vars['field']->value['id'])){?><?php echo $_smarty_tpl->tpl_vars['field']->value['id'];?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['table']->value;?>
_form_reset_btn<?php }?>"
								class="<?php if (isset($_smarty_tpl->tpl_vars['field']->value['reset']['class'])){?><?php echo $_smarty_tpl->tpl_vars['field']->value['reset']['class'];?>
<?php }else{ ?>btn btn-default<?php }?>"
								>
								<?php if (isset($_smarty_tpl->tpl_vars['field']->value['reset']['icon'])){?><i class="<?php echo $_smarty_tpl->tpl_vars['field']->value['reset']['icon'];?>
"></i><?php }?> <?php echo $_smarty_tpl->tpl_vars['field']->value['reset']['title'];?>
