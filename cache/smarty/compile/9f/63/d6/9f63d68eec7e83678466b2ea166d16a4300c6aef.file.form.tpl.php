<?php /* Smarty version Smarty-3.1.14, created on 2014-01-06 14:21:53
         compiled from "C:\xampp\htdocs\e-commerce\admin\themes\default\template\controllers\import\helpers\form\form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1933752caadf18b9fc5-02242434%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9f63d68eec7e83678466b2ea166d16a4300c6aef' => 
    array (
      0 => 'C:\\xampp\\htdocs\\e-commerce\\admin\\themes\\default\\template\\controllers\\import\\helpers\\form\\form.tpl',
      1 => 1387468848,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1933752caadf18b9fc5-02242434',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52caadf2014f12_58894158',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52caadf2014f12_58894158')) {function content_52caadf2014f12_58894158($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\xampp\\htdocs\\e-commerce\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
?>
							<tr >
								...
								<td>
									<div class="btn-group pull-right">
										<button type="button" data-filename="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['filename']->value, 'html', 'UTF-8');?>
...
&delete=1">
				...
				<div class="form-group" id="csv_file_selected" style="display: none;">
					<div class="alert alert-success clearfix">
						<input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['filename']->value;?>
" name="csv" id="csv_selected_value">
						<div class="col-lg-8">
							<span id="csv_selected_filename"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['csv_selected']->value, 'html', 'UTF-8');?>
</span>
						</div>
						<div class="col-lg-4">
							<div class="btn-group pull-right">
...
" <?php if ($_smarty_tpl->tpl_vars['lang']->value['id_lang']==$_smarty_tpl->tpl_vars['id_language']->value){?> selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['lang']->value['name'];?>
				...
				<div class="form-group">
					...
					<div class="col-lg-8">
						<input id="separator" name="separator" class="fixed-width-xs form-control" type="text" value="<?php if (isset($_smarty_tpl->tpl_vars['separator_selected']->value)){?><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['separator_selected']->value, 'html', 'UTF-8');?>
<?php }else{ ?>;<?php }?>" />
 ...
 1; Ipod; 129.90; 5</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-8">
						<input id="multiple_value_separator" name="multiple_value_separator" class="fixed-width-xs form-control" type="text" value="<?php if (isset($_smarty_tpl->tpl_vars['multiple_value_separator_selected']->value)){?><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['multiple_value_separator_selected']->value, 'html', 'UTF-8');?>
<?php }else{ ?>,<?php }?>" />
						<div class="help-block"><?php echo smartyTranslate(array('s'=>'e.g. '),$_smarty_tpl);?>
