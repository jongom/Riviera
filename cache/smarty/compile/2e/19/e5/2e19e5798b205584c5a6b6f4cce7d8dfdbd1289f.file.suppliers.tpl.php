<?php /* Smarty version Smarty-3.1.14, created on 2014-01-06 14:22:05
         compiled from "C:\xampp\htdocs\e-commerce\admin\themes\default\template\controllers\products\suppliers.tpl" */ ?>
<?php /*%%SmartyHeaderCode:336652caadfdf3d004-59495821%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2e19e5798b205584c5a6b6f4cce7d8dfdbd1289f' => 
    array (
      0 => 'C:\\xampp\\htdocs\\e-commerce\\admin\\themes\\default\\template\\controllers\\products\\suppliers.tpl',
      1 => 1387468848,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '336652caadfdf3d004-59495821',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52caadfe348456_26566840',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52caadfe348456_26566840')) {function content_52caadfe348456_26566840($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\xampp\\htdocs\\e-commerce\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
" <?php if ($_smarty_tpl->tpl_vars['supplier']->value['is_selected']==false){?>disabled="disabled"<?php }?> <?php if ($_smarty_tpl->tpl_vars['supplier']->value['is_default']==true){?>checked="checked"<?php }?> /></td>
	...
	<a class="btn btn-link bt-icon confirm_leave" href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminSuppliers'), 'html', 'UTF-8');?>
&addsupplier">
...
$_smarty_tpl->tpl_vars['supplier']->_loop = true;
 ...
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['data']['first'] = $_smarty_tpl->tpl_vars['supplier']->first;
?>
...
?>
							...
							<tr <?php if ((1 & $_smarty_tpl->tpl_vars['index']->value)){?>class="alt_row"<?php }?>>
								...
								<td>
									<input type="text" value="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['reference']->value, 'html', 'UTF-8');?>
